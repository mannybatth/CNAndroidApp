 ...
 */
public class NavigationDrawerFragment extends MyFragment implements
...
//		mStickyList.addFooterView(inflater.inflate(R.layout.list_footer, null));
        //mDrawerListView.setEmptyView(findViewById(R.id.empty));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
                            long id) {
        //Toast.makeText(getActivity(), "PollItem " + position + " clicked! " +mNavDrawerAdapter.getSectionForPosition(position), Toast.LENGTH_SHORT).show();
        selectItem(position);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        ((NavigationActivity) getActivity()).setNotificationMenuButton(menu);
    }
